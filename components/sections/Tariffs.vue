...
const tarrifsGraduation = ref([
  ...
  },
  {
    ...
    oldPrice: '35 999 ₽',
    points: [
      '2 часа 2 аниматора и крио-шоу (музыкальное сопровождение, активные и разнообразные игры с реквизитом, смешные задания, современные танцы, поздравление с выпускным и крио-шоу с изготовлением мороженого. В крио-шоу ребята попробуют повторить дыхание дракона из покорна (замороженные сладкие шарики), «почистят» зубы бешеной газировкой, исполнят свою мечту, лопнув «жемчужину желания» (мыльный шар, наполненный испарением), устроят «большой бабах» и будут танцевать в «мегатумане» (большое облако испарения)! В завершение всех деток ждёт изготовление вкусного мороженого)',
    ]
  }
])
